...
Developed by [Robert Gentleman](https://en.wikipedia.org/wiki/Robert_Gentleman_(statistician)) and [Ross Ihaka](https://en.wikipedia.org/wiki/Ross_Ihaka). 
...
In particular, [Robert Gentleman]("https://en.wikipedia.org/wiki/Robert_Gentleman_(statistician)") developed the **[Bioconductor](http://bioconductor.org/)** project where 100's of packages are directly related to computational biology and analysis of associated high-throughput experiments.
  ] 
.pull-right[
...
In R we can also create character vectors [again using **c()** function](https://rockefelleruniversity.github.io/Intro_To_R_1Day/r_course/presentations/singlepage/introToR_Session1.html#vectors22). These vectors can be indexed just the same.
...
R code for solutions can be found here  [here](../../exercises/answers/vector_answers.R)
---
...
[As we have seen with vectors](https://rockefelleruniversity.github.io/Intro_To_R_1Day/r_course/presentations/singlepage/introToR_Session1.html#vectors---character-vectors), matrices can be named. For matrices the naming is done by columns and rows using **colnames()** and **rownames()** functions.
...
Selecting and replacing portions of a matrix can be done by **indexing** using square brackets **[]** much [like for vectors](https://rockefelleruniversity.github.io/Intro_To_R_1Day/r_course/presentations/singlepage/introToR_Session1.html#vectors---indexing).
...
R code for solutions can be found [here](../../exercises/answers/matrices_answers.R)
...
[We saw that with matrices you can only have one type of data](https://rockefelleruniversity.github.io/Intro_To_R_1Day/r_course/presentations/singlepage/introToR_Session1.html#matrices_-_data_types). We tried to create a matrix with a character element and the entire matrix became a character.
...
Data frames may be indexed just [as matrices](https://rockefelleruniversity.github.io/Intro_To_R_1Day/r_course/presentations/singlepage/introToR_Session1.html#matrices_-_indexing).
...
```{r dataframesAndNoFactors_introtoR2}
dfExample <- data.frame(Name=patientName,
                        Type=patientType,
                        Survival_Time=survivalTime,
                        stringsAsFactors = F)
...
R code solutions can be found [here](../../exercises/answers/factorsAndDataframes_Answers.R)
...
[Just as with vectors](https://rockefelleruniversity.github.io/Intro_To_R_1Day/r_course/presentations/singlepage/introToR_Session1.html#vectors_-_character_vectors), list elements can be assigned names.
...
Again, [similar to vectors](https://rockefelleruniversity.github.io/Intro_To_R_1Day/r_course/presentations/singlepage/introToR_Session1.html#vectors22), lists can be joined together in R using the c() function 
...
## Coercing data formats
Sometime you do not want to have to remake an object if it is in an undesired format. There are a group of functions to coerce your data object to a new format, **as._desiredformat_()**.
...
R code for solutions can be found [here](../../exercises/answers/DataInputOutput_answers.R)
