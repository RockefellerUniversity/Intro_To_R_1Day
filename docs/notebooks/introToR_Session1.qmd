...
When you create a dataframe you can automatically make all strings be converted to factors with the **stringsAsFactors** argument. The current default though is **FALSE**
...
setwd("/Users/mattpaul/Downloads/Intro_To_R_1Day-master/r_course/")
