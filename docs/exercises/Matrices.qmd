...
HINT - We calculated LNE before in [vectors exercises' bonus question](../answers/Vectors_answers.html#bonus)
...
- Add an additional column to the original matrix which contains some GO terms associated with these genes: "Positively Regulates Transcription", "Negatively Regulates Transcription", "Positively Regulates Transcription", "Regulates Autophagy"
...
geneMatrix_transcription <- geneMatrix[grepl("transcription",GOterms, ignore.case = TRUE),]
