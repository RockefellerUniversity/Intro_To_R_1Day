...
---
# Vectors(6/17) - Indexing and replacement
...
---
# Vectors(7/17) - Indexing and replacement
...
---
# Vectors(8/17) - Arithmetic operations 
...
---
# Vectors (9/17) - Arithmetic operations  
...
---
# Vectors (10/17) - Character vectors.
...
---
# Vectors (11/17) - Character vectors as names.
...
---
# Vectors (12/17) - The unique() function
...
---
# Vectors (15/17). Logical vectors from operators
...
---
# Vectors (16/17). Combining logical vectors.
...
---
# Vectors (18/19). Logical vectors continued.
...
---
# Matrices (1/19) - Creating matrices
...
---
## Matrices (2/19) - Creating matrices
...
---
## Matrices (3/19) - Creating matrices
...
---
# Matrices (4/19) - Finding dimensions
...
---
# Matrices (5/19) (Joining vectors and matrices)
...
---
# Matrices (6/19) (Joining vectors and matrices)
...
---
# Matrices (7/19) - Joining incompatable vectors and matrices
...
---
# Matrices (8/19) - Joining incompatable vectors and matrices
...
---
# Matrices (9/19) - Column and row names
...
---
# Matrices (10/19) - Column and row names
...
---
# Matrices (15/19) - Indexing by name
...
---
# Matrices (16/19) Advanced indexing
...
---
# Matrices (17/19) - Arithmetic operations.
...
---
# Matrices (19/19) -Matrices can contain only one data type
...
---
# Data frames (1/16) - Creating data frames 
...
---
# Data frames (2/16) - Creating data frames 
...
---
# Data frames (3/16) - Indexing and replacement
...
---
# Data frames (4/16) - Using $ to specify columns
...
---
# Data frames (5/16) - Creating data frames 
...
---
### Data frames (6/16) - Creating new columns with $
...
---
### Data frames (7/16) - Indexing and replacement
...
---
### Data frames (8/16) - Indexing and replacement
...
---
# Data frames (9/16) - Factors in data frames
...
---
# Data frames (10/16) - Creating data frames without factors
...
---
# Data frames (11/16) - Ordering with order() function
...
---
# Data frames (12/16) - Ordering with NA values
...
---
# Data frames (13/16) - Ordering data frames 
...
---
# Data frames (14/16) - Ordering data frames 
...
---
# Data frames (15/16) - Merging data frames
...
---
# Data frames (16/16) - Merging data frames with merge()
