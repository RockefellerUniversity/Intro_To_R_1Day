...
Table <- rio::import("data/readThisTable.csv")
Table[1:2,]
```
...
```{r,echo=FALSE,eval=TRUE}
Table <- rio::import("data/readThisXLS.xls", 
                which=2)
Table <- rio::import("data/readThisXLS.xls", 
                which="Metadata")
Table[1:2,]
...
```{r,echo=FALSE,eval=TRUE}
ExpressionScores <- Table$ExpressionScores
rio::export(ExpressionScores,file = "data/writeThisXLSX.xlsx")
...
```{r,echo=FALSE,eval=TRUE}
names(Table) <- c("expr","meta")
rio::export(Table,file = "data/writeThisMultipleXLSX.xlsx")
